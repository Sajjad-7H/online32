...
<header class="header_section" style="position:relative">
    ...
    <nav class="navbar navbar-expand-lg custom_nav-container">
        <a class="navbar-brand" href="index.html">
            <span style="position: absolute; color: black; font-size: 24px; font-weight: bold;">EveryMart</span>
        </a>
        ...
        <div class="search_box_area_v7">
            <input id="search_mob" name="search" type="text" autocomplete="off" aria-label="search" placeholder="Search Book..." class="form-control search_box1 input-designer ui-autocomplete-input">
                ...
                @if (Route::has('login'))
                    @auth
                        ...
                        <form style="padding: 15px" method="POST" action="{{ route('logout') }}">
                            <a href="{{url('profile')}}" class="animated-link">
